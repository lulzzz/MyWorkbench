...
{
    public partial class JobCardKanban : System.Web.UI.UserControl, IXpoSessionAwareControl
    {
        ...
        //private object GetJobCardData(Session Session)
        //{
        //    return new XpoHelper(Session).GetObjects<JobCard>();
        //}

        //private void Databindkanban(Session Session)
        //{
        //    var statuses = new XpoHelper(Session).GetObjects<Status>();

        //    foreach (Status status in statuses)
        //    {
        //        this.Kanban.Columns.Add(new Syncfusion.JavaScript.Models.KanbanColumn() { HeaderText = status.Description, Key = new List<string>() { status.Description } });
        //    }

        //    this.Kanban.DataSource = this.GetJobCardData(Session);
