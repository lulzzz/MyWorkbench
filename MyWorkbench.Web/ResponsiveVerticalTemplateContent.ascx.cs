...
{
    public partial class ResponsiveVerticalTemplateContent : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder//, IHeaderImageControlContainer
    {
        static ResponsiveVerticalTemplateContent()
        {
