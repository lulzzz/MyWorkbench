...
namespace MyWorkbench.Services.Workflow
{
    ...
    {
        static readonly MyWorkbenchContext serviceContext = new MyWorkbenchContext("MyWorkbench.Services.WorkflowService", "MyWorkbench.Services.Workflow", CreateDataLayer());
