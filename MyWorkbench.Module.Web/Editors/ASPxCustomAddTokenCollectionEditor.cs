...
{
    [PropertyEditor(typeof(XPBaseCollection), "CustomAddTokenCollectionEditor", false)]
    public class ASPxCustomAddTokenCollectionEditor : ASPxPropertyEditor, IComplexViewItem
    {
        public ASPxCustomAddTokenCollectionEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model) { }
