...
namespace MyWorkbench.Module.Web.Editors {
    [PropertyEditor(typeof(BindingList), "CustomTokenBindingListEditor", false)]
    public class ASPxCustomTokenBindingListEditor : ASPxPropertyEditor, IComplexViewItem {
        public ASPxCustomTokenBindingListEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model) { }
