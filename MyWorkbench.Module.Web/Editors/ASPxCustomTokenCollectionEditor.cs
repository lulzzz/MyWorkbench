...
namespace MyWorkbench.Module.Web.Editors {
    [PropertyEditor(typeof(XPBaseCollection), "CustomTokenCollectionEditor", false)]
    public class ASPxCustomTokenCollectionEditor : ASPxPropertyEditor, IComplexViewItem {
        public ASPxCustomTokenCollectionEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model) { }
