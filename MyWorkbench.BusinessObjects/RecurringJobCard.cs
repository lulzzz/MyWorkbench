...
namespace MyWorkbench.BusinessObjects
{
    ...
    public class RecurringJobCard : WorkflowBase, IRecurringWorkFlow, IDetailRowMode
    {
        public RecurringJobCard(Session session)
            : base(session)
        {
        }
        ...
        public override WorkFlowType WorkFlowType {
            get {
                return WorkFlowType.RecurringJobCard;
            }
        }
        ...
        {
            new WorkFlowExecute<RecurringJobCard>().Execute(this);
