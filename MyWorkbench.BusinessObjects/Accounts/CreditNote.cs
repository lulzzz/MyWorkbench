...
namespace MyWorkbench.BusinessObjects.Accounts {
    ...
    public class CreditNote : WorkflowBase, ICustomizable, ITransactionType, IDetailRowMode, IAccountingPartner
    {
        public CreditNote(Session session)
            : base(session) {
        }
        ...
        public override WorkFlowType WorkFlowType {
            get {
                return WorkFlowType.CreditNote;
            }
        }
        ...
        protected override void OnSaved()
        {
            ...
            new WorkFlowExecute<CreditNote>().Execute(this);
