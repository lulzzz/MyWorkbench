...
namespace MyWorkbench.BusinessObjects.Accounts {
    ...
    public class RecurringInvoice : WorkflowBase, IRecurringWorkFlow, IDetailRowMode
    {
        public RecurringInvoice(Session session)
            : base(session) {
        }
        ...
        public override WorkFlowType WorkFlowType {
            get {
                return WorkFlowType.RecurringInvoice;
            }
        }
        ...
        {
            new WorkFlowExecute<RecurringInvoice>().Execute(this);
